...
public extension Vault.SecretEngines {
    struct IdentityClient: BackendClient {
        ...
        public func getEntityFrom(id: String) async throws(VaultError) -> VaultResponse<Entity> {
        ...
        public func writeEntityBy(name: String, entity: CreateEntityRequest) async throws(VaultError) -> VaultResponse<CreateEntityResponse> {
        ...
        public func getEntityBy(name: String) async throws(VaultError) -> VaultResponse<Entity> {
            guard !name.isEmpty else {
                throw .init(error: "Key must not be empty")
            }
